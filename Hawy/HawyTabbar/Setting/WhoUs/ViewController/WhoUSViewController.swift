...
class WhoUSViewController: BaseViewViewController {
    @IBOutlet weak var whoUSTV: UITextView!
    ...
    override func viewDidLayoutSubviews() {
        ...
        whoUSTV.roundCorners([.topLeft, .topRight], radius: 20)
    }
    ...
    func getWhoUS() {
        ...
        AF.request("https://hawy-kw.com/api/about", method: .get, parameters: nil, headers: headers)
            ...
            do {
                ...
                if productResponse.code == 200 {
                    ...
                    self.whoUSTV.text = productResponse.item?.htmlToString ?? ""
