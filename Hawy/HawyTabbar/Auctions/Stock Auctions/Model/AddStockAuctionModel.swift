...
struct AddStockAuctionModel: Codable {
    let code: Int?
    let message: String?
...
// MARK: - Item
struct AddStockAuctionItem: Codable {
    let id: Int?
...
// MARK: - Card
struct AddStockAuctionCard: Codable {
    ...
    let owner: AddStockAuctionOwner?
    let purchasedTo: AddStockAuctionOwner?
...
// MARK: - Owner
struct AddStockAuctionOwner: Codable {
    let id: Int?
